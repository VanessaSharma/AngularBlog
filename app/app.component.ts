...
@Component({
  ...
  template: `
    <div class="container">
      ...
      <h2>{{post.title}}</h2>
      <ul>
        <li *ngFor="let currentPost of posts">{{currentPost.title}}</li>
      </ul>
  </div>
  `
})
...
export class AppComponent{
  ...
  posts: Post[]= [
    new Post('How to Get Fit When You/re Really a Slob', 'All you really need to do is go for a walk, and by a walk I mean walk to your favorite gelatto place instead of driving there!', 'Fitness', 'Vanessa Sharma'),
